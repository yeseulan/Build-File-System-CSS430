...
* P5 
* 6/9/2019
* SysLib class which provides API for the users with system calls of file system. 
* This program is a modified version which includes additional functionality 
* such as close, open, format, read, write, seek, delete, fsize
*/

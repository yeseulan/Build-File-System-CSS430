...
* Group 7
* 6/9/2019
* File table entry class that holds entry of a file used from a thread
*/
public class FileTableEntry {  // Each table entry should have
    ...
    FileTableEntry ( Inode i, short inumber, String m ) {
        ...
        if ( mode.compareTo( "a" ) == 0 ) // if the mode is append mode, the seekPtr is at the end
            seekPtr = inode.length;       // of the file
    }
}
